...
//---------------------------------------------------------------------------------
	...
	public String convertir(int numero) {
		...
		if(((numero/1000)>0)&&(numero/1000<10)) { if(numero==1000) { resultado3=calcularMiles(numero/1000); }
												{ if(centenaMil==0) { if((dosUltimosDigitos/10)==0)	 { resultado3=calcularMiles(numero/1000) + " " + calcularUnidad(dosUltimosDigitos);}
			...
			/*
														  if(tresUltimosDigitos==100) { resultado3=calcularMiles(numero/1000) + " " + "cien";}
